...
if (db.data.chats[m.chat].reaction && m.text.match(/(ción|dad|aje|oso|izar|mente|pero|tion|age|ous|ate|and|but|ify|Zamas|bot|zamas|bug|syntax)/gi)) {
...
let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;Ivan 👑;;;\nFN:Ivan\nORG:Ivan 👑\nTITLE:\nitem1.TEL;waid=18134039996:+595 9999\nitem1.X-ABLabel:Ivan 👑\nX-WA-BIZ-DESCRIPTION:Solo cosas del bot.\nX-WA-BIZ-NAME:Ivan 👑\nEND:VCARD`
