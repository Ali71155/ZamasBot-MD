...
console.log(chalk.bgBlack(chalk.bold.redBright("Configure el archivo 'config.js' porque su número de WhatsApp no comienza con el código de país, Ejemplo: +595xxxx")))
process.exit(0)
}} else {
while (true) {
...
//conn.fakeReply('595972157130@s.whatsapp.net', '😃', '0@s.whatsapp.net', ' Soy ZamasBot\nRecientemente me he conectado', '0@s.whatsapp.net')
//conn.user.connect = true;
//}
